 ...
 */
public func >>- <T, U>(x: ResponseHandled<T>, f: (T) -> ResponseHandled<U>) -> ResponseHandled<U> {
  return x.flatMap(f)
}
...
/**
 ...
 - returns: A value of type `Decoded<U>`
 */
public func -<< <T, U>(f: (T) -> ResponseHandled<U>, x: ResponseHandled<T>) -> ResponseHandled<U> {
  return x.flatMap(f)
}
...
public extension ResponseHandled {
  /**
   ...
   - returns: A value of type `Decoded<U>`
   */
  func flatMap<U>(_ f: (Value) -> ResponseHandled<U>) -> ResponseHandled<U> {
    switch self {
